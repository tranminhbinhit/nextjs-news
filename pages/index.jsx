                    ...
                    >
                      <div className="jeg_news_ticker_items">
                        <div className="jeg_news_ticker_item jeg_news_ticker_animated format-standard">
                          <span>
                            <a href="https://ngoisaoexpress.net/tai-sao-khong-nen-vat-chanh-vao-do-an-van-con-nong-chuyen-gia-am-thuc-nguoi-an-do-dua-ra-loi-giai-thich/">
                              Tại sao không nên vắt chanh vào đồ ăn vẫn còn
                              nóng? Chuyên gia ẩm thực người Ấn Độ đưa ra lời
                              giải thích
                            </a>
                          </span>
                          <span className="post-date">Tháng Hai 22, 2023</span>
                        </div>
                        <div className="jeg_news_ticker_item jeg_news_ticker_animated format-standard">
                          <span>
                            <a href="https://ngoisaoexpress.net/bang-so-sanh-can-nang-chuan-cua-nu-153-175cm-ban-da-vuot-chuan-chua-dung-hieu-nham/">
                              Bảng so sánh cân nặng chuẩn của nữ 153-175cm, bạn
                              đã ‘vượt chuẩn’ chưa? Đừng hiểu nhầm!
                            </a>
                          </span>
                          <span className="post-date">Tháng Hai 22, 2023</span>
                        </div>
                        <div className="jeg_news_ticker_item jeg_news_ticker_animated format-standard fadeOutRight">
                          <span>
                            <a href="https://ngoisaoexpress.net/chong-cu-le-quyen-duoc-tang-xe-dap-dien-hon-60-trieu/">
                              Chồng cũ Lệ Quyên được tặng xe đạp điện hơn 60
                              triệu
                            </a>
                          </span>
                          <span className="post-date">Tháng Hai 22, 2023</span>
                        ...
                        <div className="jeg_news_ticker_item jeg_news_ticker_animated format-standard jeg_news_ticker_active fadeInLeft">
                          <span>
                            <a href="https://ngoisaoexpress.net/hoc-bi-quyet-deo-vong-co-nguoc-giup-sao-hollywood-chiem-tron-spotlight-tren-tham-do/">
                              Học bí quyết đeo vòng cổ ngược giúp sao Hollywood
                              chiếm trọn spotlight trên thảm đỏ
                            </a>
                          </span>
                          <span className="post-date">Tháng Hai 21, 2023</span>
                        </div>
                        <div className="jeg_news_ticker_item jeg_news_ticker_animated format-standard">
                          <span>
                            <a href="https://ngoisaoexpress.net/vuot-mat-tran-thanh-nhan-giai-lo-tai-vang-tai-ca-si-mat-na-nhung-cuoi-cung-toc-tien-lai-lam-gay-cup/">
                              ‘Vượt mặt’ Trấn Thành nhận giải Lỗ Tai Vàng tại
                              ‘Ca sĩ mặt nạ’ nhưng cuối cùng Tóc Tiên lại làm
                              gãy cúp
                            </a>
                          </span>
                          <span className="post-date">Tháng Hai 21, 2023</span>
